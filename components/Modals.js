  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {/* 🆕 Campo de coleção (Legend of Korra, X-Men, etc.) */}
        <input
          name="collection"
          placeholder="Collection (ex: Legend of Korra, X-Men)"
            ...
            <div className="text-xs text-slate-500">
              {formData.pdfUrl ? (
                ...
                <>
                  ...
                  <span className="block text-[11px] text-slate-500">
                    Selecione um PDF para que este livro seja lido dentro da
                    plataforma.
                  </span>
                </>
              )}
